...
async def test_async():
    ...
    print("  - srt_path:", source_srt, flush=True)
    print("  - project_name: test_debug", flush=True)
    print("  - episode_name: ep01", flush=True)
    print("  - config: ScriptProcessingConfig (LLM disabled)", flush=True)
